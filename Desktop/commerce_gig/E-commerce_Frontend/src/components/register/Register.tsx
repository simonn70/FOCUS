    ...
    <section className="bg-gray-50 min-h-screen flex items-center justify-center">
      ...
      <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
        ...
        <div className="md:w-1/2 px-8 md:px-16">
          <h2 className="font-bold text-2xl text-blue-400">Register {type==='dev'?"as a Dev":"as Coach"}</h2>
          <p className="text-xs mt-4 text-[#3b5d92]">
           Welcome to Dev2Win , {type==='dev'?"Start your path to greatness":"Impact lives to greatness"} 🚀
          </p>
